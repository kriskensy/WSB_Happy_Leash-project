        ...
        renderItem={({ item }) => (
          <View style={styles.listItemWithActions}>
            <ListItem
              ...
              leftElement={item.profilePictureURL && (
                <Image source={{ uri: item.profilePictureURL }} style={{ width: 48, height: 48, borderRadius: 24 }} />
              )}
            />
            <View style={styles.actionButtons}>
              ...
              <TouchableOpacity
                style={styles.actionButton}
                onPress={() => confirmDelete(item.id, `${item.firstName} ${item.lastName}`)}
              >
